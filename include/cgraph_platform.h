...
#define __CGRAPH_LONG_EPS (0xFFFFFFFFFFFFFFFFUL)
#define __CGRAPH_ULONG_EPS (0xFFFFFFFFFFFFFFFFUL)
#else
#define __CGRAPH_LONG_EPS (0xFFFFFFFFUL)
#define __CGRAPH_ULONG_EPS (0xFFFFFFFFUL)
#endif
