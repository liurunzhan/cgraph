...
#else
#ifdef _CGRAPH_INCLUDE_CGRAPH_STDINT_H
...
#if defined(__GNUC__) || defined(__clang__) || defined(HAVE_LONG_LONG)
...
#if CGRAPH_STDC_VERSION >= 199901L || defined(HAVE_LONG_DOUBLE)
