...
#define CGRAPH_INT_MASK INT_C(0xFFFFFFFF)
...
#define CGRAPH_UINT_MASK UINT_C(0xFFFFFFFF)
...
#define CGRAPH_LONG_BITS_LOG2 LONG_BITS_LOG2
...
#define CGRAPH_ULONG_BITS_LOG2 ULONG_BITS_LOG2
