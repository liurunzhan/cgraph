...
#define CGRAPH_FLOAT8_FRA_BITS (4)
#define CGRAPH_FLOAT8_FRA_OFFSET (0)
#define CGRAPH_FLOAT8_FRA_EPSILON (0xF)
#define CGRAPH_FLOAT8_EXP_BITS (3)
#define CGRAPH_FLOAT8_EXP_OFFSET CGRAPH_FLOAT8_FRA_BITS
#define CGRAPH_FLOAT8_EXP_EPSILON (0x7)
#define CGRAPH_FLOAT8_SIG_BITS (1)
#define CGRAPH_FLOAT8_SIG_OFFSET                                               \
  (CGRAPH_FLOAT8_EXP_BITS + CGRAPH_FLOAT8_FRA_BITS)
...
#define CGRAPH_FLOAT16_FRA_BITS (10)
#define CGRAPH_FLOAT16_FRA_OFFSET (0)
#define CGRAPH_FLOAT16_FRA_EPSILON (0x3FF)
#define CGRAPH_FLOAT16_EXP_BITS (5)
#define CGRAPH_FLOAT16_EXP_OFFSET CGRAPH_FLOAT16_FRA_BITS
#define CGRAPH_FLOAT16_EXP_EPSILON (0x1F)
#define CGRAPH_FLOAT16_SIG_BITS (1)
#define CGRAPH_FLOAT16_SIG_OFFSET                                              \
  (CGRAPH_FLOAT16_EXP_BITS + CGRAPH_FLOAT16_FRA_BITS)
...
#define CGRAPH_FLOAT32_FRA_BITS (23)
#define CGRAPH_FLOAT32_FRA_OFFSET (0)
#define CGRAPH_FLOAT32_FRA_EPSILON (0x7FFFFF)
#define CGRAPH_FLOAT32_EXP_BITS (8)
#define CGRAPH_FLOAT32_EXP_OFFSET CGRAPH_FLOAT32_FRA_BITS
#define CGRAPH_FLOAT32_EXP_EPSILON (0xFF)
#define CGRAPH_FLOAT32_SIG_BITS (1)
#define CGRAPH_FLOAT32_SIG_OFFSET                                              \
  (CGRAPH_FLOAT32_EXP_BITS + CGRAPH_FLOAT32_FRA_BITS)
...
#define CGRAPH_FLOAT64_FRA_BITS (52)
#define CGRAPH_FLOAT64_FRA_OFFSET (0)
#define CGRAPH_FLOAT64_FRA_EPSILON (0)
#define CGRAPH_FLOAT64_EXP_BITS (11)
#define CGRAPH_FLOAT64_EXP_OFFSET CGRAPH_FLOAT64_FRA_BITS
#define CGRAPH_FLOAT64_EXP_EPSILON (0)
#define CGRAPH_FLOAT64_SIG_BITS (1)
#define CGRAPH_FLOAT64_SIG_OFFSET                                              \
  (CGRAPH_FLOAT64_EXP_BITS + CGRAPH_FLOAT64_FRA_BITS)
...
#define CGRAPH_FLOAT128_FRA_BITS __FLOAT128_FRA_BITS
#define CGRAPH_FLOAT128_FRA_OFFSET __FLOAT128_FRA_OFFSET
#define CGRAPH_FLOAT128_FRA_EPSILON __FLOAT128_FRA_EPSILON
