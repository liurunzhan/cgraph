...
#define CGRAPH_LONG_EPS LONG_EPS
#define CGRAPH_LONG_BITS __WORDSIZE
#define CGRAPH_LONG_BITS_LOG2 __WORDSIZE_LOG2
#define CGRAPH_LONG_EPS1 LONG_EPS1
#define CGRAPH_LONG_EPS2 LONG_EPS2
#define CGRAPH_LONG_EPS4 LONG_EPS4
#define CGRAPH_LONG_EPS8 LONG_EPS8
#define CGRAPH_LONG_EPS16 LONG_EPS16
#define CGRAPH_LONG_EPS32 LONG_EPS32
#define CGRAPH_LONG_EPS64 LONG_EPS64
#define CGRAPH_LONG_IN_FMT "%" SCNdlg
#define CGRAPH_LONG_OUT_FMT "%" PRIdlg
/** @} */
...
#define CGRAPH_ULONG_EPS ULONG_EPS
#define CGRAPH_ULONG_BITS __WORDSIZE
#define CGRAPH_ULONG_BITS_LOG2 __WORDSIZE_LOG2
#define CGRAPH_ULONG_EPS1 ULONG_EPS1
#define CGRAPH_ULONG_EPS2 ULONG_EPS2
#define CGRAPH_ULONG_EPS4 ULONG_EPS4
#define CGRAPH_ULONG_EPS8 ULONG_EPS8
#define CGRAPH_ULONG_EPS16 ULONG_EPS16
#define CGRAPH_ULONG_EPS32 ULONG_EPS32
#define CGRAPH_ULONG_EPS64 ULONG_EPS64
#define CGRAPH_ULONG_IN_FMT "%" SCNulg
#define CGRAPH_ULONG_OUT_FMT "%" PRIulg
/** @} */
...
#define CGRAPH_SIZE_IN_FMT "%" SCNdlg
#define CGRAPH_SIZE_OUT_FMT "%" PRIdlg
/** @} */
...
#define CGRAPH_USIZE_IN_FMT "%" SCNulg
#define CGRAPH_USIZE_OUT_FMT "%" PRIulg
/** @} */
...
#define CGRAPH_INT8_EPS INT8_EPS
#define CGRAPH_INT8_BITS INT8_BITS
#define CGRAPH_INT8_BITS_LOG2 INT8_BITS_LOG2
...
#define CGRAPH_UINT8_EPS UINT8_EPS
#define CGRAPH_UINT8_BITS UINT8_BITS
#define CGRAPH_UINT8_BITS_LOG2 UINT8_BITS_LOG2
...
#define CGRAPH_INT16_EPS INT16_EPS
#define CGRAPH_INT16_BITS INT16_BITS
#define CGRAPH_INT16_BITS_LOG2 INT16_BITS_LOG2
...
#define CGRAPH_UINT16_EPS UINT16_EPS
#define CGRAPH_UINT16_BITS UINT16_BITS
#define CGRAPH_UINT16_BITS_LOG2 UINT16_BITS_LOG2
...
#define CGRAPH_INT32_EPS INT32_EPS
#define CGRAPH_INT32_BITS INT32_BITS
#define CGRAPH_INT32_BITS_LOG2 INT32_BITS_LOG2
...
#define CGRAPH_UINT32_EPS UINT32_EPS
#define CGRAPH_UINT32_BITS UINT32_BITS
#define CGRAPH_UINT32_BITS_LOG2 UINT32_BITS_LOG2
...
#define CGRAPH_INT64_EPS INT64_EPS
#define CGRAPH_INT64_BITS INT64_BITS
#define CGRAPH_INT64_BITS_LOG2 INT64_BITS_LOG2
#define CGRAPH_INT64_IN_FMT "%" SCNd64
#define CGRAPH_INT64_OUT_FMT "%" PRId64
#define CGRAPH_INT64_EPS1 INT64_EPS1
#define CGRAPH_INT64_EPS2 INT64_EPS2
#define CGRAPH_INT64_EPS4 INT64_EPS4
#define CGRAPH_INT64_EPS8 INT64_EPS8
#define CGRAPH_INT64_EPS16 INT64_EPS16
#define CGRAPH_INT64_EPS32 INT64_EPS32
#define CGRAPH_INT64_EPS64 INT64_EPS64
/** @} */
...
#define CGRAPH_UINT64_EPS UINT64_EPS
#define CGRAPH_UINT64_BITS UINT64_BITS
#define CGRAPH_UINT64_BITS_LOG2 UINT64_BITS_LOG2
#define CGRAPH_UINT64_IN_FMT "%" SCNu64
#define CGRAPH_UINT64_OUT_FMT "%" PRIu64
#define CGRAPH_UINT64_EPS1 UINT64_EPS1
#define CGRAPH_UINT64_EPS2 UINT64_EPS2
#define CGRAPH_UINT64_EPS4 UINT64_EPS4
#define CGRAPH_UINT64_EPS8 UINT64_EPS8
#define CGRAPH_UINT64_EPS16 UINT64_EPS16
#define CGRAPH_UINT64_EPS32 UINT64_EPS32
#define CGRAPH_UINT64_EPS64 UINT64_EPS64
/** @} */
...
#define CGRAPH_INT128_EPS INT128_EPS
#define CGRAPH_INT128_BITS INT128_BITS
#define CGRAPH_INT128_BITS_LOG2 INT128_BITS_LOG2
#define CGRAPH_INT128_IN_FMT "%" SCNd128
#define CGRAPH_INT128_OUT_FMT "%" PRId128
#define CGRAPH_INT128_EPS1 INT128_EPS1
#define CGRAPH_INT128_EPS2 INT128_EPS2
#define CGRAPH_INT128_EPS4 INT128_EPS4
#define CGRAPH_INT128_EPS8 INT128_EPS8
#define CGRAPH_INT128_EPS16 INT128_EPS16
#define CGRAPH_INT128_EPS32 INT128_EPS32
#define CGRAPH_INT128_EPS64 INT128_EPS64
#define CGRAPH_INT128_EPS128 INT128_EPS128
/** @} */
...
#define CGRAPH_UINT128_EPS UINT128_EPS
#define CGRAPH_UINT128_BITS UINT128_BITS
#define CGRAPH_UINT128_BITS_LOG2 UINT128_BITS_LOG2
#define CGRAPH_UINT128_IN_FMT "%" UINT128_IN_FMT
#define CGRAPH_UINT128_OUT_FMT "%" UINT128_OUT_FMT
#define CGRAPH_UINT128_EPS1 UINT128_EPS1
#define CGRAPH_UINT128_EPS2 UINT128_EPS2
#define CGRAPH_UINT128_EPS4 UINT128_EPS4
#define CGRAPH_UINT128_EPS8 UINT128_EPS8
#define CGRAPH_UINT128_EPS16 UINT128_EPS16
#define CGRAPH_UINT128_EPS32 UINT128_EPS32
#define CGRAPH_UINT128_EPS64 UINT128_EPS64
#define CGRAPH_UINT128_EPS128 UINT128_EPS128
/** @} */
...
#define CGRAPH_FLOAT8_IN_FMT "%" SCNu8
#define CGRAPH_FLOAT8_OUT_FMT "%" SCNu8
...
#define CGRAPH_FLOAT16_IN_FMT "%d"
#define CGRAPH_FLOAT16_OUT_FMT "%d"
