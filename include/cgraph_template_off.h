 ...
 * TYPE_INT128_SIZE128
 * TYPE_TIME TYPE_COMPLEX TYPE_FRACTION TYPE_POINT2D TYPE_POINT3D
 ...
 * MSB LSB SIGNBIT MASK EPSILON EPSILON_LEN
 * HASH_OFFSET
 ...
 * MACRO GROUP : TYPE DATA PARSER
 * COMPLEX_REAL COMPLEX_IMAG FRACTION_NUM FRACTION_DEN
