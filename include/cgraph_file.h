...
#define CGRAPH_FILE_CBUFFER_SIZE CGRAPH_CBUFFER_SIZE5
...
extern cgraph_size_t cgraph_file_fputs(FILE *fp, const cgraph_char_t *cbuffer,
                                       const cgraph_size_t size);
extern cgraph_size_t cgraph_file_rfputs(FILE *fp, const cgraph_char_t *cbuffer,
                                        const cgraph_size_t size);
extern cgraph_size_t cgraph_file_sprintnl(cgraph_char_t *cbuffer,
                                          const cgraph_size_t size,
...
extern cgraph_size_t cgraph_file_vsnprintf(cgraph_char_t *cbuffer,
                                           const cgraph_size_t size,
                                           const cgraph_char_t *format,
                                           va_list args);
extern cgraph_size_t cgraph_file_snprintf(cgraph_char_t *cbuffer,
                                          const cgraph_size_t size,
                                          const cgraph_char_t *format, ...);

extern FILE *cgraph_file_fopen(cgraph_char_t *file, cgraph_char_t *mode);
extern cgraph_bool_t cgraph_file_fclose(FILE *fp);
extern cgraph_size_t cgraph_file_fgets(FILE *fp, cgraph_char_t *cbuffer,
                                       const cgraph_size_t size);
extern cgraph_size_t cgraph_file_row(FILE *fp, cgraph_char_t *cbuffer,
                                     const cgraph_size_t size,
                                     const cgraph_size_t line);
extern cgraph_size_t cgraph_file_whole(FILE *fp, cgraph_char_t *cbuffer,
                                       const cgraph_size_t size);
extern cgraph_size_t cgraph_file_header(FILE *fp, cgraph_char_t *cbuffer,
                                        const cgraph_size_t size);
extern cgraph_size_t cgraph_file_row(FILE *fp, cgraph_char_t *cbuffer,
                                     const cgraph_size_t size,
