...
int main(int argc, char *argv[]) {
  ...
  fprintf(stdout, " and ");
  FUNCTION(NAME, fprint)(stdout, bignum7);
  fprintf(stdout, " GT compare : %d\n", FUNCTION(NAME, gt)(bignum6, bignum7));
  FUNCTION(NAME, fprint)(stdout, bignum6);
  fprintf(stdout, " and ");
  FUNCTION(NAME, fprint)(stdout, bignum8);
  fprintf(stdout, " GT compare : %d\n", FUNCTION(NAME, gt)(bignum6, bignum8));
  FUNCTION(NAME, fprint)(stdout, bignum6);
  fprintf(stdout, " and ");
  FUNCTION(NAME, fprint)(stdout, bignum9);
  fprintf(stdout, " GT compare : %d\n", FUNCTION(NAME, gt)(bignum6, bignum9));
  FUNCTION(NAME, fprint)(stdout, bignum7);
  fprintf(stdout, " and ");
  FUNCTION(NAME, fprint)(stdout, bignum8);
  fprintf(stdout, " GT compare : %d\n", FUNCTION(NAME, gt)(bignum7, bignum8));
  FUNCTION(NAME, fprint)(stdout, bignum7);
  fprintf(stdout, " and ");
  FUNCTION(NAME, fprint)(stdout, bignum9);
  fprintf(stdout, " GT compare : %d\n", FUNCTION(NAME, gt)(bignum7, bignum9));
  FUNCTION(NAME, fprint)(stdout, bignum8);
  fprintf(stdout, " and ");
  FUNCTION(NAME, fprint)(stdout, bignum9);
  fprintf(stdout, " GT compare : %d\n", FUNCTION(NAME, gt)(bignum8, bignum9));
  FUNCTION(NAME, fprint)(stdout, bignum9);
  fprintf(stdout, " and ");
  FUNCTION(NAME, fprint)(stdout, bignum9);
  fprintf(stdout, " GT compare : %d\n", FUNCTION(NAME, gt)(bignum9, bignum9));
  ...
  fprintf(stdout, " and ");
  FUNCTION(NAME, fprint)(stdout, bignum3);
  fprintf(stdout, " GT compare : %d\n", FUNCTION(NAME, gt)(bignum2, bignum3));
