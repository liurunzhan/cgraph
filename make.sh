...
# python3 $tool/macro.py $inc/cgraph_template_off.h -t $tool/template_off.macro -c "end of cgraph_template_off" --nodoc
# python3 $tool/macro.py $inc/cgraph_template_check.h -t $tool/template_check.macro -c "end of cgraph_template_check" --nodoc
